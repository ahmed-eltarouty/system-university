...
namespace App\Http\Livewire\Sudents;
   ...
   // semester type 1:summer 0:normal   semester_status 1:active 0:inactive
    ...
    public function add_after_check($sub){
        if(($this->total_can_register -= $this->current_subject->study_hours) >= 0){ //check available hours
            Semester::find($this->semester_id)->subjects()->create([
    ...
    public function render()
    {
        ...
        return view('livewire.sudents.add-semester',['subjects'=>$subjects,'selected_subjects'=>$this->selected_subjects])->layout('livewire.layouts.admin');
    }
}
