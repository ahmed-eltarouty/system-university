                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.add-student')}}"> تعديل المادة </a>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form"> تعديل المادة </h4>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="" id="students_number"
                                                               class="form-control"
                                                               placeholder="عدد الطلاب المسموح به للمادة  "
...
{{--
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="finished_subject1" wire:model="finished_subject1" class="select2 form-control">
