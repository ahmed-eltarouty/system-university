                                        ...
                                        @isset($students)
                                            @foreach($students as $student)
                                                <tr>
                                                    ...
                                                    <td>{{$student -> total_finished_hours}}</td>
                                                    <td>{{$student -> GPA}}</td>
                                                    <td>{{$student -> CGPA}}</td>
                                                    <td>{{$student -> status ? 'مفعل':'غير مفعل'}}</td>
                                                    <td>
                                                        <div class="btn-group" role="group" aria-label="Basic example">
                                                            <a href="{{route('show-student.details',$student->id)}}" class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">عرض</a>
